...
const AVERAGE_SPEED_KMH = 40; // Set an assumed average speed in km/h for ETA calculation
...
const Train = () => {
  ...
  const handleFeedbackSubmit = async () => {
    ...
    try {
      await setDoc(doc(db, "train_feedback", `route_${routeNumber}_${Date.now()}`), feedbackData);
